...
export default function Header() {
  ...
  return (
    <header className="bg-[#E42541] text-white py-1">
            ...
            <form onSubmit={handleSearch} className="w-full max-w-2xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-2 border-none rounded-full text-black placeholder-gray-400 text-sm"
                  value={searchQuery}
          ...
          <div className="flex-none flex items-center space-x-4">
              ...
              {username ? (
                <>
                  ...
                  >
                    ...
                    <span className="hidden lg:inline font-medium whitespace-nowrap text-sm">
                  ...
                  {showDropdown && (
                    <div className="absolute right-0 mt-2 w-40 bg-white text-black shadow-lg rounded-lg z-50">
                      <ul className="py-1">
                        ...
                        <li
                          className="px-3 py-1.5 hover:bg-gray-100 cursor-pointer text-red-500 text-sm"
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-1 rounded-md hover:bg-red-600 focus:outline-none"
              >
                {mobileMenuOpen ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-red-400">
          <div className="px-3 pt-2 pb-2 space-y-1">
            ...
            <div
              className="flex items-center gap-1 px-3 py-1.5 rounded-md text-sm font-medium hover:bg-red-600"
              onClick={() => {
                navigate("/cart");
